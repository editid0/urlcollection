...
// create table collections(id SERIAL PRIMARY KEY, name TEXT, created_at TIMESTAMP, updated_at TIMESTAMP, user_id TEXT, description TEXT, public BOOL DEFAULT FALSE, uid UUID);
